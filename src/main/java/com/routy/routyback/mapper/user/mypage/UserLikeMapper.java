...
public interface UserLikeMapper {
     ...
     * @return 좋아요 목록 리스트
     */
    List<UserLikeResponse> selectUserLikeProducts(@Param("userNo") Long userNo,
     ...
     */
    int insertLike(@Param("userNo") Long userNo,
     ...
     */
    int deleteLike(@Param("userNo") Long userNo,
        @Param("productId") Long productId,
        @Param("type") String type);
     ...
     */
    int countLike(@Param("userNo") Long userNo,
        @Param("productId") Long productId,
        @Param("type") String type);
}